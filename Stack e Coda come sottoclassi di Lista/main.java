...
public class main
{
    ...
    public static void main(String [] args) throws Exception 
    {
        ...
        for(int i=0;i<1;i=i)
        {
            ...
            System.out.println("11 per eliminare la lista"); 
            System.out.println("12 per cercare un elemento nella lista"); 
            System.out.println("13 per inserire una stringa nella seconda lista");
            System.out.println("14 per concatenare le 2 liste"); 
            System.out.println("15 per inserire la seconda lista in una certa posizione");
            System.out.println("16 per inserire un nuovo oggetto in coda"); 
            System.out.println("17 per eliminare un oggetto in coda"); 
            System.out.println("18 per aggiungere un oggetto nella pila"); 
            System.out.println("19 per eliminare un oggetto in coda"); 
            System.out.println(">");
            appo=Integer.parseInt(tastiera.readLine());
                ...
                else if(appo==12)
                {
                    ...
                    System.out.println("Il nodo e' nella posizione");
                ...
                if(appo==15)
                {
                    ...
                    System.out.println(">");
                    pos=Integer.parseInt(tastiera.readLine());
                    lista.insListaInPosizione (pos ,lista1);
                }
                if(appo==16)
                {
                    System.out.println("Inserisci una stringa");

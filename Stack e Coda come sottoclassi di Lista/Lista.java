public class Lista
{
    ...
    public void insListaInPosizione (int pos, Lista l) throws Exception
        {
        try
        {
        l.getCoda().setSuccessivo(leggiPosizione(pos));
        leggiPosizione (pos-1).setSuccessivo(l.getTesta());
        }
        catch ( Exception e )
        {
        throw new Exception() ;
